...
main.interactions = function (game) {
	...
	function update(player, boss, item, platforms) {
		var hitPlatform,
			itemIsInRange;
	...
	function handleKillBoss(e, bossIsInRange) {
		if (e.isDown && bossIsInRange) {
			that.notifyAll("playerKillsBoss");
		}
	}
