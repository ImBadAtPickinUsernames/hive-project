...
main = (function () {
	...
	function update() {
		...
		interactions.update(player.getPlayer(), npcs.getBossNpc(), items.getCoffeeMugItem(), obstacles.getPlatforms());
